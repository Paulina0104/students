...
(function (global, factory) {
  ...
  var Defaults = {
    ...
    // Return the `$element` where errors_customs will be appended
    // Could also be (and given directly from DOM) a valid selector like `'#div'`
    errorsContainer: function errorsContainer(Field) {},

    // ul elem that would receive errors_customs' list
    errorsWrapper: '<ul class="parsley-errors_customs-list"></ul>',
          ...
          if ('number' === type) {
            if (!/^any$/i.test(step || '')) {
              ...
              if (decimalPlaces(nb) > decimals) // Value can't have too many decimals
                return false;
              // Be careful of rounding errors_customs by using integers.
  ...
  UI.Field = {
    ...
    _reflowUI: function _reflowUI() {
      ...
      // Add, remove, updated errors_customs messages
    ...
    _buildUI: function _buildUI() {
      ...
      // $errorsWrapper is a div that would contain the various field errors_customs, it will be appended into $errorsContainer
    ...
    _insertErrorWrapper: function _insertErrorWrapper() {
      ...
      if ('string' === typeof this.options.errorsContainer) {
        if ($(this.options.errorsContainer).length) return $(this.options.errorsContainer).append(this._ui.$errorsWrapper);else Utils.warn('The errors_customs container `' + this.options.errorsContainer + '` does not exist in DOM');
