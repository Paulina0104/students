...
;(function (global, factory) {
    ...
    function Duration (duration) {
        ...
        this._milliseconds = +milliseconds +
            seconds * 1e3 + // 1000
            minutes * 6e4 + // 1000 * 60
            hours * 1000 * 60 * 60; //using 1000 * 60 * 60 instead of 36e5 to avoid floating point rounding errors_customs https://github.com/moment/moment/issues/2978
    ...
    function as (units) {
        ...
        if (units === 'month' || units === 'year') {
            ...
            // handle milliseconds separately because of floating point math errors_customs (issue #1867)
            ...
            switch (units) {
                ...
                // Math.floor prevents floating point math errors_customs here
